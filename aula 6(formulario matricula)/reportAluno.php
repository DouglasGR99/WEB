...
<body>
    <main class="caixas">
        ...
        <form action="modificar.php" method="post">
            <input class="negativo botaoBonito botaoArquivo" type="submit" name="modificar" value="Remover Aluno">
        </form>
        <a href="formularioAluno.php"><button class="botaoBonito botaoPagina">Voltar ao Formulário</button></a>
        <?php fclose($arcDisc); ?>
    </main>
</body>
</html>